...
function delete_id(id)
{
	...
	{
		window.location.href='ani_b.php?delete_id='+id;
	}
}
</script>
</head>
...
<nav class="navbar navbar-default " role="navigation">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="ani_b.php">Dreamzone Student Record </a>
		</div>
...
<div style="overflow-x:auto;">
    ...
    <?php
	$sql_query="SELECT * FROM student WHERE department='ani'";
